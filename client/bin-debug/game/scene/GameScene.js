...
var GameScene = (function (_super) {
    ...
    GameScene.prototype.setBg = function (id) {
        // if(this._bgId == id)
        //     return;
    ...
    GameScene.prototype.initBgLayer = function (num) {
    ...
    GameScene.prototype.getBgLayer = function (num) {
        if (this._bglayers.length - 1 >= num) {
            return this._bglayers[num];
        }
        return null;
    };
    GameScene.prototype.getTopBgLayer = function () {
        var len = this._bglayers.length;
        return this._bglayers[len - 1];
    };
    GameScene.prototype.addImg = function (name, x, y, clear) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
    ...
    GameScene.prototype.showModel = function () {
        if (this._bgId != 0) {
            var bgconf = BgConfig.Dic.get(this._bgId);
            if (bgconf.Type == 0) {
