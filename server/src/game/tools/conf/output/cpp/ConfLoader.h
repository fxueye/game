...
#include "QuotesDataConfig.h"
#include "QuotesListConfig.h"
#include "QuotesTreeConfig.h"
...
//			using rapidjson::Document;
	...
	public:
		void load(string path){
             ...
             QuotesDataConfig::parse(readJsonFile(path + "/" + "quotesdataconfig.json"));
             QuotesListConfig::parse(readJsonFile(path + "/" + "quoteslistconfig.json"));
             QuotesTreeConfig::parse(readJsonFile(path + "/" + "quotestreeconfig.json"));
